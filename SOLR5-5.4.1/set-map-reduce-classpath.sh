...
libC1=`ls $dir1/*.jar | awk '{print "file://"$1":"}' | tr -d ' \n' | sed 's/.$//'`
libC2=`ls $dir2/*.jar | awk '{print "file://"$1":"}' | tr -d ' \n' | sed 's/.$//' | sed 's/\:[^\:]*\(log4j\|slf4j\)[^\:]*//g'`
libC3=`ls $dir3/*.jar | awk '{print "file://"$1":"}' | tr -d ' \n' | sed 's/.$//' | sed 's/\:[^\:]*\(hadoop\)[^\:]*//g'`
libC4=`ls $dir4/*.jar | awk '{print "file://"$1":"}' | tr -d ' \n' | sed 's/.$//'`
libC5=`ls $dir5/*.jar | awk '{print "file://"$1":"}' | tr -d ' \n' | sed 's/.$//'`
libC6=`ls $dir6/*.jar | awk '{print "file://"$1":"}' | tr -d ' \n' | sed 's/.$//'`
libC7=`ls $dir7/*.jar | awk '{print "file://"$1":"}' | tr -d ' \n' | sed 's/.$//' | sed 's/\:[^\:]*\(hadoop\)[^\:]*//g'`
...
export HADOOP_CLASSPATH="$libC1:$libC2:$libC3:$libC4:$libC5:$libC6:$libC7"
